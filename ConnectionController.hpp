...
/*   Updated: 2025/03/10 11:22:58 by bworrawa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class ConnectionController 
{
	...
	public:
		...
		bool			handleRead(int clientSocket, struct epoll_event& event, HttpRequest &httpRequest, HttpResponse &httpResponse);
		bool			handleWrite(int clientSocket, struct epoll_event& event, HttpRequest &httpRequest, HttpResponse &httpResponse);
